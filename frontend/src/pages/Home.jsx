            ...
            <nav className="relative z-50 w-full border-b border-white/[0.08] bg-[#0A0806]/80 backdrop-blur-xl">
                <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4">
                        <a href="https://github.com/Aadityaanand2002/LeetCode-Detective" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-white transition-colors">
            ...
            <footer className="border-t border-white/[0.05] bg-transparent py-8 relative z-10 mt-12">
                <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-gray-500">
                    ...
                    <div className="flex gap-6">
                        ...
                        <a href="https://github.com/Aadityaanand2002/LeetCode-Detective" target="_blank" rel="noreferrer" className="hover:text-white transition-colors">GitHub</a>
                    </div>
                </div>
            </footer>
        </div>
