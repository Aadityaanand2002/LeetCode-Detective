...
function Home() {
    ...
    const handleAddContest = (e) => {
        ...
        const updated = [{ name, slug }, ...contests];
        setContests(updated);
    ...
    return (
        <div className="min-h-screen bg-transparent relative flex flex-col font-sans overflow-x-hidden">
            {/* Base Atmosphere */}
            <div className="fixed inset-0 fractalNoise pointer-events-none opacity-40 z-0" />

            {/* Cyberpunk Perspective Grid Background */}
            <div className="cyber-sky-glow" />
            ...
            <nav className="relative z-50 w-full border-b border-white/[0.08] bg-[#0A0806]/80 backdrop-blur-xl">
                <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4">
                        <a href="https://github.com/adityaanand15902/LeetCode-Contest-Plagarism-Detector" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-white transition-colors">
            ...
            <main className="flex-1 relative z-10 w-full">
                ...
                <section className="max-w-7xl mx-auto px-6 pt-24 pb-32">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            <div className="flex flex-wrap items-center gap-3 mb-8">
                                ...
                                <div className="inline-flex items-center px-3 py-1 rounded-full bg-white/5 border border-white/10 text-gray-400 text-xs font-medium">
                                    Developed by <span className="text-white ml-1 font-semibold">Aditya Anand</span>
                                </div>
                            </div>
                            <h1 className="text-5xl lg:text-7xl font-bold tracking-tight text-white mb-6 leading-[1.1]">
                                Stop Code Plagiarism <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500">Dead</span> in its Tracks.
                            </h1>
                        ...
                        >
                            <div className="absolute inset-0 bg-gradient-to-tr from-cyan-500/20 to-transparent blur-3xl -z-10" />
                            <div className="glass-panel p-1 rounded-2xl border border-white/10 bg-[#0A0806]/80 overflow-hidden shadow-2xl">
                                ...
                                <div className="p-6 font-mono text-sm text-gray-400 space-y-4">
                                    ...
                                    <div className="flex gap-4 animate-pulse">
                                        ...
                                        <span className="pl-4 text-cyan-400 font-semibold">{'>'} HIGH RISK DETECTED: 94% SIMILARITY</span>
                                    </div>
                                </div>
                            </div>
                        </motion.div>
                ...
                <section className="border-y border-white/[0.05] bg-white/[0.02] backdrop-blur-sm relative z-20 py-24">
                    <div className="max-w-7xl mx-auto px-6">
                        ...
                        >
                            <motion.div variants={itemVariants} className="glass-card p-8 group hover:border-cyan-500/30 transition-colors duration-500">
                            ...
                            {isAdding ? (
                                ...
                                >
                                    <input
                                        ...
                                        className="bg-[#0A0806] border border-white/10 rounded-md px-4 py-2 text-sm text-white placeholder:text-gray-600 focus:outline-none focus:border-cyan-500/50 w-64"
                                        autoFocus
                                    />
                                        ...
                                        <Link to={`/contest/${contest.slug}`} className="block h-full">
                                            <div className="glass-card p-6 h-full flex flex-col justify-between hover:border-white/20 transition-all duration-300">
                                                <div className="flex justify-between items-start mb-6">
                                                    <div className="w-10 h-10 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 group-hover:text-white group-hover:bg-cyan-500/10 group-hover:border-cyan-500/30 transition-all">
                                                ...
                                                <div>
                                                    <h3 className="text-lg font-semibold text-white mb-1 group-hover:text-cyan-400 transition-colors">{contest.name}</h3>
            ...
            <footer className="border-t border-white/[0.05] bg-transparent py-8 relative z-10 mt-12">
                <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-gray-500">
                    ...
                    <div className="flex gap-6">
                        ...
                        <a href="https://github.com/adityaanand15902/LeetCode-Contest-Plagarism-Detector" target="_blank" rel="noreferrer" className="hover:text-white transition-colors">GitHub</a>
                    </div>
                </div>
            </footer>
        </div>
